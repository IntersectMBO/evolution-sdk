...
If you discover a security vulnerability in evolution-sdk, we encourage you to
responsibly disclose it to us. To report a vulnerability, please use
the [private reporting form on
GitHub](https://github.com/IntersectMBO/evolution-sdk/security/advisories/new)
...
- The version of `evolution-sdk` package where the vulnerability exists.
...
The Evolution SDK project greatly appreciates the assistance of the security
